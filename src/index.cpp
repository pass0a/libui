...
extern "C" int passoa_init(pa_plugin p) {
    const pa_function_list_entry my_module_funcs[] = {
        ...
        { "newTab", libuiNewTab, PA_VARARGS /*nargs*/ },
        { "tabAppend", libuiTabAppend, PA_VARARGS /*nargs*/ },
        { "tabInsertAt", libuiTabInsertAt, PA_VARARGS /*nargs*/ },
        { "tabDelete", libuiTabDelete, PA_VARARGS /*nargs*/ },
        { "tabNumPages", libuiTabNumPages, PA_VARARGS /*nargs*/ },
        { "tabMargined", libuiTabMargined, PA_VARARGS /*nargs*/ },
        { "tabSetMargined", libuiTabSetMargined, PA_VARARGS /*nargs*/ },
